...
class HomeWarmPanel extends React.Component {
  ...
  sliderChange = (type) => {
    ...
    //   }
    // }
    this.props.areaImgSlider(1) 
  }
  render() {
    return (
      <div className='home-warm-panel' style={{right: '25%'}}>   
        <div className='float-right'>
          <div className='panel-title clearfix'>
            ...
            <div className='float-left' style={{cursor:'pointer',color:'#fff'}} onClick={this.sliderChange}><Icon style={{verticalAlign:'text-bottom',fontSize: '20px',marginRight: '5px'}} type="reload" />还原</div>
