...
public class SysCommHostsDO implements Serializable {
	/**
	 * 
	 */
	...
	private List<SysCommDevicesDO> devices;
	...
	public List<SysCommDevicesDO> getDevices() {
		return devices;
	}

	public void setDevices(List<SysCommDevicesDO> devices) {
